...
?>
              ...
              <li><span class="fa fa-phone"></span><a href="tel:+7-0551-5576"> +<?php  echo $row['MobileNumber'];?></a></li>
              <li><span class="fa fa-envelope-open-o"></span><a href="mailto:smwaniki289@gmail.com" class="mail">
          ...
          <div class="col-lg-4 col-md-6 col-sm-4 footer-list-29 footer-2 ">
            ...
            <ul>
              ...
              <li><a href="services.php"> properties</a></li>
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© 2024 DJ johnsons INTL</p>
