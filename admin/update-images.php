...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  tblcars set Image='$newimage' where ID='$eid' ");
    if ($query) {
...
<html>
<head>
<title>JD & Johnsons | Update cars</title>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">name</label> <input type="text" class="form-control" id="name" name="name" placeholder="name" value="<?php  echo $row['name'];?>" readonly="true"> </div>
