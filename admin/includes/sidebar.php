  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="add-services.php"><i class="fa fa-home nav_icon"></i>Property<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
                  <a href="add-services.php">Add Property</a>
                </li>
                <li>
                  <a href="manage-services.php">Manage Property</a>
                </li>
              </ul>
              <li>
              <a href="add-car.php"><i class="fa fa-cogs nav_icon"></i>Cars<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
                  <a href="add-car.php">Add cars</a>
                </li>
                <li>
                  <a href="manage-car.php">Manage cars</a>
                </li>
              </ul>
              <!-- /nav-second-level -->
            </li>
            ...
            <li>
              ...
              <ul class="nav nav-second-level collapse">
                ...
                <li>
                  <a href="accepted-appointment.php">Accepted Appointments</a>
                </li>
                <li>
                  <a href="rejected-appointment.php">Rejected Appointments</a>
                </li>
              </ul>
              <!-- //nav-second-level -->
            </li>
